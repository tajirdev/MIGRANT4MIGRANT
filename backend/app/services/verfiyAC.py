...
def verify_account(request: ForgotPasswordRequest, db: Session):
    ...
    try:
        ...
        msg['To'] = user.email
        msg['Subject'] = "Your Migrant4Migrant  Verfication Code"
                ...
                <tr>
                    ...
                    <table border="0" cellpadding="0" cellspacing="0" width="100%" style="max-width: 500px; background-color: #ffffff; border-radius: 12px; overflow: hidden; border: 1px solid #4ECDC4; box-shadow: 0 4px 12px rgba(45, 52, 54, 0.05);">
                        ...
                        <td style="padding: 40px 32px; background-color: #ffffff;">
                            <h2 style="color: #2D3436; font-size: 22px; font-weight: 600; margin-top: 0; margin-bottom: 16px;">Profile Verification</h2>
                            ...
                            We received a request to verify your email address directly from your profile settings. To confirm this security check and update your account status, please use the 6-digit verification code below:
                            </p>
                            ...
                            This security code will expire in <span style="padding: 2px 6px; border-radius: 4px; font-weight: bold; color: #4ECDC4;">20 minutes</span>. For protection, please do not forward or share this verification code with anyone.
                            </p>
                        </td>
                        </tr>
                        ...
                        <td style="background-color: #F9F9F9; padding: 28px 32px; text-align: center; border-top: 1px solid #4ECDC4;">
                            ...
                            If you did not request this security verification from your profile dashboard, please secure your account credentials immediately or disregard this email.
                            </p>

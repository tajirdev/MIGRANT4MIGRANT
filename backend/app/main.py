...
from .routes import RouteUser, RouterResources,authenticationRoute,adminRoute,MentorRouter,emergencyrouter,RouteOrganization
...
origins = [
    ...
    "http://127.0.0.1:5501",   # Live Server default
...
app.include_router(RouteOrganization.router)